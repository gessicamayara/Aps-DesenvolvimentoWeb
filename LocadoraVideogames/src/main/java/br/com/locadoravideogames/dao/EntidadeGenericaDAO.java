...
//Essa classe DAO servirá para todas as entidades de forma genérica
...
public class EntidadeGenericaDAO<Entidade> {
	...
	public void salvar(Entidade entidade) {
		...
		Transaction transacao = null; // declaração de objetos Transaction para garantir que mais de uma operação
										// sendo realizadas, as duas serão concluídas
